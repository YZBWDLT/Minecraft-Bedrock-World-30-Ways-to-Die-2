...
## 开启开发者功能时
execute @e[name=developerMode,scores={settings=1}] ~~~ execute @e[name=levelAdvancement,scores={stats=30}] ~~~ tellraw @a {"rawtext":[{"translate":"feedback.error.level_unlocked"}]}
...
execute @e[name=developerMode,scores={settings=1}] ~~~ execute @e[name=levelAdvancement,scores={stats=!30}] ~~~ tellraw @a {"rawtext":[{"translate":"feedback.level_unlocked"}]}
