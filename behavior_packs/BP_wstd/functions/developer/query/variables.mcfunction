...
execute if score oplevel settings matches 2 run tellraw @s {"rawtext":[{"translate":"functions.developer.query.variables.succeed.data.language","with":{"rawtext":[{"score":{"objective":"settings","name":"language"}}]}}]}
