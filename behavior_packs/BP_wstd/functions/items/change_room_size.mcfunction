...
## 提示语
execute @e[name=level,scores={backend=51..60}] ~~~ execute @e[name=diyEditMode,scores={backend=1}] ~~~ execute @e[name=diyRoomSize,scores={backend=0}] ~~~ tellraw @a {"rawtext":[{"translate":"chat.item.change_room_size.small"}]} 
execute @e[name=level,scores={backend=51..60}] ~~~ execute @e[name=diyEditMode,scores={backend=1}] ~~~ execute @e[name=diyRoomSize,scores={backend=1}] ~~~ tellraw @a {"rawtext":[{"translate":"chat.item.change_room_size.middle"}]} 
execute @e[name=level,scores={backend=51..60}] ~~~ execute @e[name=diyEditMode,scores={backend=1}] ~~~ execute @e[name=diyRoomSize,scores={backend=2}] ~~~ tellraw @a {"rawtext":[{"translate":"chat.item.change_room_size.large"}]} 
