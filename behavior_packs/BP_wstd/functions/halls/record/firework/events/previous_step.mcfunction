...
# --- 减少步骤 ---
scoreboard players remove fireworkTutorial.step data 1
execute if score fireworkTutorial.step data matches !1..8 run scoreboard players set fireworkTutorial.step data 8
