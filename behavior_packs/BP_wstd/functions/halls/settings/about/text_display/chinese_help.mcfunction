...
# --- 翻页内容 ---
## 这些内容是全面适配网易的！毕竟是懒得再写isNetease data了，如果你想要看国际版的，请移步GitHub的main分支

## 1
execute if score settingCenter.help data matches 1 run summon wstd:text_display "§l§b问题 1" -103 21.8 51
execute if score settingCenter.help data matches 1 run summon wstd:text_display "§b写在前面" -103 21.5 51
execute if score settingCenter.help data matches 1 run summon wstd:text_display "§l§a回答 1" -103 21.0 51
...
execute if score settingCenter.help data matches 1 run summon wstd:text_display "§a也可以来企鹅group：673941729提问（这个回复更快更及时一些）！" -103 20.1 51

## 2
execute if score settingCenter.help data matches 2 run summon wstd:text_display "§l§b问题 2" -103 21.8 51
execute if score settingCenter.help data matches 2 run summon wstd:text_display "§b地图难度不是我想选的怎么办？" -103 21.5 51
execute if score settingCenter.help data matches 2 run summon wstd:text_display "§l§a回答 2" -103 21.0 51
...
## 3
execute if score settingCenter.help data matches 3 run summon wstd:text_display "§l§b问题 3" -103 21.8 51
execute if score settingCenter.help data matches 3 run summon wstd:text_display "§b地图怎么这么大？四五十MB？" -103 21.5 51
execute if score settingCenter.help data matches 3 run summon wstd:text_display "§l§a回答 3" -103 21.0 51
execute if score settingCenter.help data matches 3 run summon wstd:text_display "§a这是因为地图内置了许多的BGM，音乐占大头" -103 20.7 51

## 4
execute if score settingCenter.help data matches 4 run summon wstd:text_display "§l§b问题 4" -103 21.8 51
execute if score settingCenter.help data matches 4 run summon wstd:text_display "§b地图玩起来有点卡...？" -103 21.5 51
execute if score settingCenter.help data matches 4 run summon wstd:text_display "§l§a回答 4" -103 21.0 51
...
execute if score settingCenter.help data matches 4 run summon wstd:text_display "§a所以这种问题我给出的解决方案就是：换个游玩设备" -103 20.1 51

## 5
execute if score settingCenter.help data matches 5 run summon wstd:text_display "§l§b问题 5" -103 21.8 51
execute if score settingCenter.help data matches 5 run summon wstd:text_display "§b自定义死亡信息是怎么做到的？想学..." -103 21.5 51
execute if score settingCenter.help data matches 5 run summon wstd:text_display "§l§a回答 5" -103 21.0 51
...
## 6
execute if score settingCenter.help data matches 6 run summon wstd:text_display "§l§b问题 6" -103 21.8 51
execute if score settingCenter.help data matches 6 run summon wstd:text_display "§b开了困难，结果不会过关，怎么办？" -103 21.5 51
execute if score settingCenter.help data matches 6 run summon wstd:text_display "§l§a回答 6" -103 21.0 51
execute if score settingCenter.help data matches 6 run summon wstd:text_display "§a参见回答 2哦~" -103 20.7 51

## 7
execute if score settingCenter.help data matches 7 run summon wstd:text_display "§l§b问题 7" -103 21.8 51
execute if score settingCenter.help data matches 7 run summon wstd:text_display "§b钓鱼怎么全是河豚呀！怎么做到的？" -103 21.5 51
execute if score settingCenter.help data matches 7 run summon wstd:text_display "§l§a回答 7" -103 21.0 51
execute if score settingCenter.help data matches 7 run summon wstd:text_display "§a因为我改了战利品表，不光如此，猪灵的战利品表也改过了" -103 20.7 51
execute if score settingCenter.help data matches 7 run summon wstd:text_display "§a这个版本还加入了更多的战利品表，感兴趣的话可以" -103 20.4 51
execute if score settingCenter.help data matches 7 run summon wstd:text_display "§a自行分析地图的addon看看哦" -103 20.1 51

## 8
execute if score settingCenter.help data matches 8 run summon wstd:text_display "§l§b问题 8" -103 21.8 51
execute if score settingCenter.help data matches 8 run summon wstd:text_display "§b第30关挖遍地图也不知道怎么过关..." -103 21.5 51
execute if score settingCenter.help data matches 8 run summon wstd:text_display "§l§a回答 8" -103 21.0 51
...
## 9
execute if score settingCenter.help data matches 9 run summon wstd:text_display "§l§b问题 9" -103 21.8 51
execute if score settingCenter.help data matches 9 run summon wstd:text_display "§b玩完所有30关就是通关了吧！" -103 21.5 51
execute if score settingCenter.help data matches 9 run summon wstd:text_display "§l§a回答 9" -103 21.0 51
...
## 10
execute if score settingCenter.help data matches 10 run summon wstd:text_display "§l§b问题 10" -103 21.8 51
execute if score settingCenter.help data matches 10 run summon wstd:text_display "§b彩蛋在哪儿？" -103 21.5 51
execute if score settingCenter.help data matches 10 run summon wstd:text_display "§l§a回答 10" -103 21.0 51
...
execute if score settingCenter.help data matches 10 run summon wstd:text_display "§a这再找不到就不能怪我了，已经很显眼了..." -103 20.1 51

## 11
execute if score settingCenter.help data matches 11 run summon wstd:text_display "§l§b问题 11" -103 21.8 51
execute if score settingCenter.help data matches 11 run summon wstd:text_display "§b想开坐标..." -103 21.5 51
execute if score settingCenter.help data matches 11 run summon wstd:text_display "§l§a回答 11" -103 21.0 51
...
## 12
execute if score settingCenter.help data matches 12 run summon wstd:text_display "§l§b问题 12" -103 21.8 51
execute if score settingCenter.help data matches 12 run summon wstd:text_display "§b这地图的防作弊怎么关？" -103 21.5 51
execute if score settingCenter.help data matches 12 run summon wstd:text_display "§l§a回答 12" -103 21.0 51
execute if score settingCenter.help data matches 12 run summon wstd:text_display "§a既然你问起来了，说明你已经发现了这地图有防作弊了" -103 20.7 51
...
## 13
execute if score settingCenter.help data matches 13 run summon wstd:text_display "§l§b问题 13" -103 21.8 51
execute if score settingCenter.help data matches 13 run summon wstd:text_display "§b地图能联机吗？" -103 21.5 51
execute if score settingCenter.help data matches 13 run summon wstd:text_display "§l§a回答 13" -103 21.0 51
execute if score settingCenter.help data matches 13 run summon wstd:text_display "§a我建议是别吧...... " -103 20.7 51
execute if score settingCenter.help data matches 13 run summon wstd:text_display "§a虽然能联机，但效果不好，我试过 " -103 20.4 51

## 14
execute if score settingCenter.help data matches 14 run summon wstd:text_display "§l§b问题 14" -103 21.8 51
execute if score settingCenter.help data matches 14 run summon wstd:text_display "§b地图很好玩！我可以推荐给我的好友玩吗？" -103 21.5 51
execute if score settingCenter.help data matches 14 run summon wstd:text_display "§l§a回答 14" -103 21.0 51
...
## 15
execute if score settingCenter.help data matches 15 run summon wstd:text_display "§l§b问题 15" -103 21.8 51
execute if score settingCenter.help data matches 15 run summon wstd:text_display "§b作者大大有其他的地图吗？我可以体验吗？" -103 21.5 51
execute if score settingCenter.help data matches 15 run summon wstd:text_display "§l§a回答 15" -103 21.0 51
...
execute if score settingCenter.help data matches 15 if score isNetease data matches 1 run summon wstd:text_display "§a当然！进入group：673941729 企鹅就可体验到我最新的地图！" -103 20.7 51

## 16
execute if score settingCenter.help data matches 16 run summon wstd:text_display "§l§b问题 16" -103 21.8 51
...
execute if score settingCenter.help data matches 16 run summon wstd:text_display "§l§a回答 16" -103 21.0 51
...
execute if score settingCenter.help data matches 16 if score isNetease data matches 1 run summon wstd:text_display "§a当你看到这段的时候，我已经用特殊手段检测到了你在用China Edition，" -103 20.7 51
...
execute if score settingCenter.help data matches 16 if score isNetease data matches 1 run summon wstd:text_display "§c我太难啦..." -103 19.8 51

## 17
execute if score settingCenter.help data matches 17 run summon wstd:text_display "§l§b问题 17" -103 21.8 51
execute if score settingCenter.help data matches 17 run summon wstd:text_display "§b作者大大的联系方式？" -103 21.5 51
execute if score settingCenter.help data matches 17 run summon wstd:text_display "§l§a回答 17" -103 21.0 51
...
execute if score settingCenter.help data matches 17 if score isNetease data matches 1 run summon wstd:text_display "§a1543585291 [企鹅] | [企鹅group]673941729（推荐！）" -103 20.7 51
...
## 18
execute if score settingCenter.help data matches 18 run summon wstd:text_display "§l§b问题 18" -103 21.8 51
execute if score settingCenter.help data matches 18 run summon wstd:text_display "§b地图有Bug！我卡关了......" -103 21.5 51
execute if score settingCenter.help data matches 18 run summon wstd:text_display "§l§a回答 18" -103 21.0 51
...
execute if score settingCenter.help data matches 18 run summon wstd:text_display "§a§o（可能也许或许大概似乎好像貌似说不定没准maybe可以吧）" -103 20.1 51

## 19
execute if score settingCenter.help data matches 19 run summon wstd:text_display "§l§b问题 19" -103 21.8 51
execute if score settingCenter.help data matches 19 run summon wstd:text_display "§b地图做的不戳！我想分析地图，应该从何开始呢？" -103 21.5 51
execute if score settingCenter.help data matches 19 run summon wstd:text_display "§l§a回答 19" -103 21.0 51
...
## 20
execute if score settingCenter.help data matches 20 run summon wstd:text_display "§l§b问题 20" -103 21.8 51
execute if score settingCenter.help data matches 20 run summon wstd:text_display "§b我还有其他问题！" -103 21.5 51
execute if score settingCenter.help data matches 20 run summon wstd:text_display "§l§a回答 20" -103 21.0 51
execute if score settingCenter.help data matches 20 run summon wstd:text_display "§a在评论区或来群里问吧~" -103 20.7 51
execute if score settingCenter.help data matches 20 run summon wstd:text_display "§a作者很希望各位能够在群里多活跃的哦" -103 20.4 51

## 21
execute if score settingCenter.help data matches 21 run summon wstd:text_display "§l§b问题 21" -103 21.8 51
execute if score settingCenter.help data matches 21 run summon wstd:text_display "§b考虑用其他网盘之类的提供下载链接吗？" -103 21.5 51
execute if score settingCenter.help data matches 21 run summon wstd:text_display "§l§a回答 21" -103 21.0 51
