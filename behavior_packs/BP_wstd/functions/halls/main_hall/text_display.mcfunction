...
execute @e[name=easterEggAdvancement,scores={stats=0}] ~~~ execute @e[name=levelAdvancement,scores={stats=30}] ~~~ execute @e[name=language,scores={settings=0}] ~~~ summon wstd:text_display "§c彩蛋位置提示：那个地图是可以穿过去的qwq" 28 11.0 23.1
...
execute @e[name=language,scores={settings=0}] ~~~ summon wstd:text_display "§3在大厅会轮播一些随机提示，其中有一些可能是你未完成进度的突破口哦~" 28 10.7 23.1
