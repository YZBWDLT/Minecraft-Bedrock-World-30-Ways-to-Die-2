...
## 显示展示文本
execute if score language settings matches 0 run function halls/hub/main/text_display/chinese
execute if score language settings matches 1 run function halls/hub/main/text_display/english
