...
## 显示展示文本
execute if score language data matches 0 run function halls/hub/easter_egg/text_display/chinese
execute if score language data matches 1 run function halls/hub/easter_egg/text_display/english
