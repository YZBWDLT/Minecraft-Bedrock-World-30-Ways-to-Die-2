...
execute @e[name=language,scores={settings=0}] ~~~ execute @e[name=developerMode,scores={settings=1}] ~~~ summon wstd:text_display "§b适配模式设置" -108 20.2 49
execute @e[name=language,scores={settings=0}] ~~~ execute @e[name=developerMode,scores={settings=1}] ~~~ execute @e[name=isNetease,scores={settings=0}] ~~~ summon wstd:text_display "§b当前：国际版" -108 19.9 49
execute @e[name=language,scores={settings=0}] ~~~ execute @e[name=developerMode,scores={settings=1}] ~~~ execute @e[name=isNetease,scores={settings=1}] ~~~ summon wstd:text_display "§b当前：Netease" -108 19.9 49
...
## --- 以下内容受开发者模式开启与关闭控制 ---
execute @e[name=language,scores={settings=1}] ~~~ execute @e[name=developerMode,scores={settings=1}] ~~~ summon wstd:text_display "§bAdaption Mode" -108 20.2 49
execute @e[name=language,scores={settings=1}] ~~~ execute @e[name=developerMode,scores={settings=1}] ~~~ execute @e[name=isNetease,scores={settings=0}] ~~~ summon wstd:text_display "§bNow: International" -108 19.9 49
execute @e[name=language,scores={settings=1}] ~~~ execute @e[name=developerMode,scores={settings=1}] ~~~ execute @e[name=isNetease,scores={settings=1}] ~~~ summon wstd:text_display "§bNow: Netease" -108 19.9 49
