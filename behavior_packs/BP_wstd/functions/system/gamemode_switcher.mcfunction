...
## 切换为冒险模式
tellraw @a[m=!adventure,hasitem={item=netherbrick,location=slot.weapon.mainhand}] {"rawtext":[{"translate":"chat.developer.gamemode_switcher"}]}
...
## 切换为旁观模式
tellraw @a[m=!spectator,hasitem={item=ender_pearl,location=slot.weapon.mainhand}] {"rawtext":[{"translate":"chat.developer.gamemode_switcher"}]}
