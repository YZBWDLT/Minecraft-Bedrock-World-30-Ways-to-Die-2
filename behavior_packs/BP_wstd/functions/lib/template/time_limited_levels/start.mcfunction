...
## (设置关卡的ID，举例：scoreboard players set level data 38
...
## 重置关卡房间
## (设置关卡的重置位置和内容，举例：structure load time_limited:level_1 39 20 43
...
## (显示主标题，举例：titleraw @a title {"rawtext":[{"translate":"title.time_limited_1"}]}
## (显示副标题，举例：titleraw @a subtitle {"rawtext":[{"translate":"subtitle.time_limited_1"}]}
...
## 物品检测
## (是否启用物品检测？举例：scoreboard players set level9.itemTestCraftingTable active 1
## 展示文本
...
## 设置限时时长
## (设置限时关卡的时长，举例：scoreboard players set remainingTime time 150
