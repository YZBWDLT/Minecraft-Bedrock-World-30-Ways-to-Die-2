...
## (设置关卡的ID，举例：scoreboard players set level data 7
...
## 重置关卡房间
## (设置关卡的重置位置和内容，举例：structure load mainline:level_1 39 20 43
...
## (显示主标题，举例：titleraw @a title {"rawtext":[{"translate":"title.level_1"}]}
## (显示副标题，举例：titleraw @a subtitle {"rawtext":[{"translate":"subtitle.level_1"}]}
