...
execute @e[name=speedrunMode,scores={settings=0}] ~~~ scoreboard players set "§lDiff §r§aEasy" display1 4
...
# tellraw与音效
execute @e[name=speedrunMode,scores={settings=0}] ~~~ tellraw @a {"rawtext":[{"translate":"chat.settings.difficulty.easy"}]}
