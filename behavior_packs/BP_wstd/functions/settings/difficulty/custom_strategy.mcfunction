...
# 提示
execute @e[name=speedrunMode,scores={settings=0}] ~~~ execute @e[name=strategyEnabled,scores={settings=1}] ~~~ tellraw @a {"rawtext":[{"translate":"settings.difficulty.strategy.enabled"}]}
execute @e[name=speedrunMode,scores={settings=0}] ~~~ execute @e[name=strategyEnabled,scores={settings=0}] ~~~ tellraw @a {"rawtext":[{"translate":"settings.difficulty.strategy.disabled"}]}
