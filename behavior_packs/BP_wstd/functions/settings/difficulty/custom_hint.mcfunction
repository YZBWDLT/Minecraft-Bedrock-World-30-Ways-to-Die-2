...
# 提示
execute @e[name=speedrunMode,scores={settings=0}] ~~~ execute @e[name=hintEnabled,scores={settings=1}] ~~~ tellraw @a {"rawtext":[{"translate":"settings.difficulty.hint.enabled"}]}
execute @e[name=speedrunMode,scores={settings=0}] ~~~ execute @e[name=hintEnabled,scores={settings=0}] ~~~ tellraw @a {"rawtext":[{"translate":"settings.difficulty.hint.disabled"}]}
