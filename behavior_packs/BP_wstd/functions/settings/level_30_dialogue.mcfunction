...
execute @e[name=levelAdvancement,scores={stats=0..32,stats=!29..30}] ~~~ execute @e[name=level30Dialogue,scores={settings=0}] ~~~ tellraw @a {"rawtext":[{"translate":"settings.level_30_dialogue.disabled"}]}
execute @e[name=levelAdvancement,scores={stats=0..32,stats=!29..30}] ~~~ execute @e[name=level30Dialogue,scores={settings=2}] ~~~ tellraw @a {"rawtext":[{"translate":"settings.level_30_dialogue.enabled"}]}
...
execute @e[name=levelAdvancement,scores={stats=29..30}] ~~~ execute @e[name=level30Dialogue,scores={settings=0}] ~~~ tellraw @a {"rawtext":[{"translate":"settings.level_30_dialogue.disabled"}]}
execute @e[name=levelAdvancement,scores={stats=29..30}] ~~~ execute @e[name=level30Dialogue,scores={settings=1}] ~~~ tellraw @a {"rawtext":[{"translate":"settings.level_30_dialogue.enabled"}]}
