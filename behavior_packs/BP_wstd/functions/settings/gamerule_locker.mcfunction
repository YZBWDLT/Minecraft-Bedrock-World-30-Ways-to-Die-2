...
execute @e[name=gameruleLocker,scores={settings=0}] ~~~ tellraw @a {"rawtext":[{"translate":"chat.settings.gamerule.unlocked"}]}
execute @e[name=gameruleLocker,scores={settings=1}] ~~~ tellraw @a {"rawtext":[{"translate":"chat.settings.gamerule.locked"}]}
