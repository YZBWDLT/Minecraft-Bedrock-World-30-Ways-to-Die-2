...
# 复制房间
execute @e[name=language,scores={settings=0}] ~~~ structure load easter_egg_7 -40 20 -70
execute @e[name=language,scores={settings=1}] ~~~ structure load easter_egg_7_en -40 20 -70
