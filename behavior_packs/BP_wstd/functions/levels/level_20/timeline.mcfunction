...
execute @e[name=itemTester1,scores={active=1}] ~~~ give @p crafting_table 1 0 {"minecraft:can_place_on":{"blocks":["emerald_block","quartz_block","glass","stained_glass","quartz_stairs","obsidian","grass","dirt","soul_sand","soul_soil","stone","tallgrass","netherrack"]}}
...
execute @e[name=timeline,scores={time=19}] ~~~ execute @e[name=itemTester2,scores={active=2}] ~~~ execute @a[hasitem={item=brewing_stand}] ~~~ scoreboard players set @e[name=itemTester2] active 1
execute @e[name=itemTester2,scores={active=1}] ~~~ clear @a minecraft:brewing_stand
execute @e[name=itemTester2,scores={active=1}] ~~~ give @p brewing_stand 1 0 {"minecraft:can_place_on":{"blocks":["emerald_block","quartz_block","glass","stained_glass","quartz_stairs","obsidian","grass","dirt","soul_sand","soul_soil","stone","tallgrass","netherrack"]}}
...
execute @e[name=timeline,scores={time=19}] ~~~ execute @e[name=itemTester3,scores={active=2}] ~~~ execute @a[hasitem={item=water_bucket}] ~~~ scoreboard players set @e[name=itemTester3] active 1
execute @e[name=itemTester3,scores={active=1}] ~~~ clear @a minecraft:water_bucket
