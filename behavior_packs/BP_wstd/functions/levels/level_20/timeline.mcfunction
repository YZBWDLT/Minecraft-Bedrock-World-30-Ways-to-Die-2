...
execute @e[name=itemTester2,scores={active=1}] ~~~ tellraw @p {"rawtext":[{"translate":"chat.item_tester.placeable_block","with":{"rawtext":[{"translate":"item.brewing_stand.name"}]}}]}
...
execute @e[name=itemTester3,scores={active=1}] ~~~ tellraw @p {"rawtext":[{"translate":"chat.item_tester.destroyable_tool","with":{"rawtext":[{"translate":"item.bucketWater.name"}]}}]}
