...
execute @e[name=diyEditMode,scores={backend=0}] ~~~ setblock -103 2 -18 redstone_block
...
execute @e[name=diyEditMode,scores={backend=1}] ~~~ replaceitem entity @a slot.inventory 0 barrier
execute @e[name=diyEditMode,scores={backend=1}] ~~~ replaceitem entity @a slot.inventory 1 command_block
execute @e[name=diyEditMode,scores={backend=1}] ~~~ replaceitem entity @a slot.inventory 2 allow
