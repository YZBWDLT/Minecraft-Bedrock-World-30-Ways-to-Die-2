...
# -68 21 -23/-27
# 在第0个问题下的选择
execute @e[name=counter,scores={backend=0}] ~~~ execute @a[x=-68,y=21,z=-23,r=1] ~~~ tellraw @a {"rawtext":[{"translate":"chat.level.easter_egg_2.question_0.right"}]}
...
execute @e[name=counter,scores={backend=0}] ~~~ execute @a[x=-68,y=21,z=-27,r=1] ~~~ tellraw @a {"rawtext":[{"translate":"chat.level.easter_egg_2.question_0.wrong"}]}
...
# 在第1个问题下的选择
execute @e[name=counter,scores={backend=1}] ~~~ execute @a[x=-68,y=21,z=-23,r=1] ~~~ tellraw @a {"rawtext":[{"translate":"chat.level.easter_egg_2.question_1.right"}]}
...
execute @e[name=counter,scores={backend=1}] ~~~ execute @a[x=-68,y=21,z=-27,r=1] ~~~ tellraw @a {"rawtext":[{"translate":"chat.level.easter_egg_2.question_1.wrong"}]}
...
# 在第2个问题下的选择
execute @e[name=counter,scores={backend=2}] ~~~ execute @a[x=-68,y=21,z=-23,r=1] ~~~ tellraw @a {"rawtext":[{"translate":"chat.level.easter_egg_2.question_2.right"}]}
...
execute @e[name=counter,scores={backend=2}] ~~~ execute @a[x=-68,y=21,z=-27,r=1] ~~~ tellraw @a {"rawtext":[{"translate":"chat.level.easter_egg_2.question_2.wrong"}]}
...
# 在第3个问题下的选择
execute @e[name=counter,scores={backend=3}] ~~~ execute @a[x=-68,y=21,z=-23,r=1] ~~~ tellraw @a {"rawtext":[{"translate":"chat.level.easter_egg_2.question_3.right"}]}
...
execute @e[name=counter,scores={backend=3}] ~~~ execute @a[x=-68,y=21,z=-27,r=1] ~~~ tellraw @a {"rawtext":[{"translate":"chat.level.easter_egg_2.question_3.wrong"}]}
...
# 在第4个问题下的选择
execute @e[name=counter,scores={backend=4}] ~~~ execute @a[x=-68,y=21,z=-23,r=1] ~~~ tellraw @a {"rawtext":[{"translate":"chat.level.easter_egg_2.question_4.right"}]}
...
execute @e[name=counter,scores={backend=4}] ~~~ execute @a[x=-68,y=21,z=-27,r=1] ~~~ tellraw @a {"rawtext":[{"translate":"chat.level.easter_egg_2.question_4.wrong"}]}
...
# 在第5个问题下的选择
execute @e[name=counter,scores={backend=5}] ~~~ execute @a[x=-68,y=21,z=-23,r=1] ~~~ tellraw @a {"rawtext":[{"translate":"chat.level.easter_egg_2.question_5.right"}]}
