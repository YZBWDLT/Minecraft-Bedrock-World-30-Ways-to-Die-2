...
execute @e[name=itemTester2,scores={active=1}] ~~~ clear @a minecraft:furnace
execute @e[name=itemTester2,scores={active=1}] ~~~ give @p furnace 1 0 {"can_place_on":{"blocks":["gold_block"]}}
execute @e[name=itemTester2,scores={active=1}] ~~~ tellraw @p {"rawtext":[{"translate":"chat.placeable_block","with":{"rawtext":[{"translate":"tile.furnace.name"}]}}]}
...
execute @e[name=itemTester3,scores={active=1}] ~~~ clear @a minecraft:brewing_stand
execute @e[name=itemTester3,scores={active=1}] ~~~ give @p brewing_stand 1 0 {"can_place_on":{"blocks":["gold_block"]}}
execute @e[name=itemTester3,scores={active=1}] ~~~ tellraw @p {"rawtext":[{"translate":"chat.placeable_block","with":{"rawtext":[{"translate":"item.brewing_stand.name"}]}}]}
...
execute @e[name=itemTester4,scores={active=1}] ~~~ clear @a minecraft:stone_pickaxe
...
execute @e[name=itemTester4,scores={active=1}] ~~~ tellraw @p {"rawtext":[{"translate":"chat.destroyable_tool","with":{"rawtext":[{"translate":"item.stone_pickaxe.name"}]}}]}
...
execute @e[name=itemTester5,scores={active=1}] ~~~ clear @a minecraft:wooden_pickaxe
execute @e[name=itemTester5,scores={active=1}] ~~~ give @p wooden_pickaxe 1 0 {"can_destroy":{"blocks":["stone"]}}
execute @e[name=itemTester5,scores={active=1}] ~~~ tellraw @p {"rawtext":[{"translate":"chat.destroyable_tool","with":{"rawtext":[{"translate":"item.wooden_pickaxe.name"}]}}]}
execute @e[name=itemTester5,scores={active=1}] ~~~ scoreboard players set @e[name=itemTester5] active 0

# 炼药锅
execute @a[c=1] ~~~ detect -89 22 107 cauldron 6 give @s minecraft:spider_eye
execute @a[c=1] ~~~ detect -89 22 107 cauldron 6 tellraw @a {"rawtext":[{"translate":"chat.hided_3.gift"}]}
execute @a[c=1] ~~~ detect -89 22 107 cauldron 6 setblock -89 22 107 minecraft:cauldron ["cauldron_liquid":"water","fill_level":0]