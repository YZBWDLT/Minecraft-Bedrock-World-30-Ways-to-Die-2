...
# 自定义死亡信息
execute @a ~~~ tellraw @s {"rawtext":[{"translate":"chat.deathmessage.easter_egg_1.tree","with":{"rawtext":[{"selector":"@s"}]}}]}
execute @a ~~~ tellraw @s {"rawtext":[{"translate":"chat.deathmessage.easter_egg_1","with":{"rawtext":[{"selector":"@s"}]}}]}
