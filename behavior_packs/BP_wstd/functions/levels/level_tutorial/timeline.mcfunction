...
execute @e[name=timeline,scores={time=40}] ~~~ execute @a ~~~ tellraw @s {"rawtext":[{"translate":"chat.level.tutorial.line1","with":{"rawtext":[{"selector":"@s"}]}}]}
execute @e[name=timeline,scores={time=40}] ~~~ execute @a ~~~ playsound random.pop @s

execute @e[name=timeline,scores={time=120}] ~~~ execute @a ~~~ tellraw @s {"rawtext":[{"translate":"chat.level.tutorial.line2"}]}
execute @e[name=timeline,scores={time=120}] ~~~ execute @a ~~~ playsound random.pop @s

execute @e[name=timeline,scores={time=200}] ~~~ execute @a ~~~ tellraw @s {"rawtext":[{"translate":"chat.level.tutorial.line3"}]}
...
execute @e[name=timeline,scores={time=280}] ~~~ execute @a ~~~ tellraw @s {"rawtext":[{"translate":"chat.level.tutorial.line4"}]}
...
execute @e[name=timeline,scores={time=301}] ~~~ execute @a ~~~ tellraw @s {"rawtext":[{"translate":"chat.level.tutorial.line5"}]}

### 停止计时，等待玩家下一步操作
execute @e[name=timeline,scores={time=341}] ~~~ scoreboard players set @s active 2

execute @e[name=timeline,scores={time=440}] ~~~ execute @a ~~~ tellraw @s {"rawtext":[{"translate":"chat.level.tutorial.line6"}]}
execute @e[name=timeline,scores={time=440}] ~~~ execute @a ~~~ playsound random.pop @s

execute @e[name=timeline,scores={time=520}] ~~~ execute @a ~~~ tellraw @s {"rawtext":[{"translate":"chat.level.tutorial.line7"}]}
execute @e[name=timeline,scores={time=520}] ~~~ execute @a ~~~ playsound random.pop @s

execute @e[name=timeline,scores={time=600}] ~~~ execute @a ~~~ tellraw @s {"rawtext":[{"translate":"chat.level.tutorial.line8"}]}
...
execute @e[name=timeline,scores={time=740}] ~~~ execute @a ~~~ tellraw @s {"rawtext":[{"translate":"chat.level.tutorial.line9"}]}
execute @e[name=timeline,scores={time=740}] ~~~ execute @a ~~~ playsound random.pop @s

execute @e[name=timeline,scores={time=820}] ~~~ execute @a ~~~ tellraw @s {"rawtext":[{"translate":"chat.level.tutorial.line10"}]}
...
execute @e[name=timeline,scores={time=940}] ~~~ execute @a ~~~ tellraw @s {"rawtext":[{"translate":"chat.level.tutorial.line11"}]}
execute @e[name=timeline,scores={time=940}] ~~~ execute @a ~~~ playsound random.pop @s

execute @e[name=timeline,scores={time=1020}] ~~~ execute @a ~~~ tellraw @s {"rawtext":[{"translate":"chat.level.tutorial.line12"}]}
execute @e[name=timeline,scores={time=1020}] ~~~ execute @a ~~~ playsound random.pop @s

execute @e[name=timeline,scores={time=1100}] ~~~ execute @a ~~~ tellraw @s {"rawtext":[{"translate":"chat.level.tutorial.line13"}]}
...
execute @e[name=timeline,scores={time=1180}] ~~~ execute @a ~~~ tellraw @s {"rawtext":[{"translate":"chat.level.tutorial.line14"}]}
...
execute @e[name=timeline,scores={time=1240}] ~~~ execute @a ~~~ tellraw @s {"rawtext":[{"translate":"chat.level.tutorial.line15"}]}
execute @e[name=timeline,scores={time=1240}] ~~~ execute @a ~~~ playsound random.pop @s

execute @e[name=timeline,scores={time=1320}] ~~~ execute @a ~~~ tellraw @s {"rawtext":[{"translate":"chat.level.tutorial.line16"}]}
...
execute @e[name=timeline,scores={time=1400}] ~~~ execute @a ~~~ tellraw @s {"rawtext":[{"translate":"chat.level.tutorial.line17"}]}
...
execute @e[name=timeline,scores={time=1480}] ~~~ execute @a ~~~ tellraw @s {"rawtext":[{"translate":"chat.level.tutorial.line18"}]}
execute @e[name=timeline,scores={time=1480}] ~~~ execute @a ~~~ playsound random.pop @s

execute @e[name=timeline,scores={time=1560}] ~~~ execute @a ~~~ tellraw @s {"rawtext":[{"translate":"chat.level.tutorial.line19"}]}
execute @e[name=timeline,scores={time=1560..1563}] ~~~ execute @a ~~~ playsound random.pop @s

execute @e[name=timeline,scores={time=1640}] ~~~ execute @a ~~~ tellraw @s {"rawtext":[{"translate":"chat.level.tutorial.line20"}]}
