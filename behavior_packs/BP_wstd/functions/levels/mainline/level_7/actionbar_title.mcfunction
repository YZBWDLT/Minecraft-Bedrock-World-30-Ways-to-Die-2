...
# --- 非速通模式 ---
execute if score speedrunMode settings matches 0 as @a run titleraw @s actionbar {"rawtext":[{"translate":"%%s %%s | §7%%s","with":{"rawtext":[{"translate":"title.level_7"},{"translate":"subtitle.level_7"},{"translate":"actionbar.description.level_7"}]}}]}
