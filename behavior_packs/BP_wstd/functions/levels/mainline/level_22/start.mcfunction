...
## 重置关卡房间
execute if score language settings matches 0 run structure load mainline:level_22 10 20 92
execute if score language settings matches 1 run structure load mainline:level_22_en 10 20 92
...
## 箱子的纸条显示
execute if score language settings matches 0 run function levels/mainline/level_22/events/set_paper_zh
execute if score language settings matches 1 run function levels/mainline/level_22/events/set_paper_en
