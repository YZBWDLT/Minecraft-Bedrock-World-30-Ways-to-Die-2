...
## 给予可用的物品
give @s bed 1 6 {"can_place_on":{"blocks":["quartz_block","quartz_stairs","glass","stained_glass","emerald_block"]}}
...
## 停止该物品的检测
scoreboard players set level10.itemTestPinkBed active 0
