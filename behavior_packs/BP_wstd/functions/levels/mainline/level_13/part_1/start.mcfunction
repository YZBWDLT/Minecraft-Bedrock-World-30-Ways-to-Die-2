...
## 展示文本
execute if score language data matches 0 run function levels/mainline/level_13/part_1/text_display/chinese
execute if score language data matches 1 run function levels/mainline/level_13/part_1/text_display/english
