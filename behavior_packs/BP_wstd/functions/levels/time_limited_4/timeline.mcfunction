...
tellraw @a[x=-57,y=21,z=-99,dx=8,dy=9,dz=8] {"rawtext":[{"translate":"chat.level.time_limited_4.fell_into_hole"}]}
...
### 僵尸猪灵掉进坑里时，游戏重置
execute @e[type=zombie_pigman,x=-54,y=21,z=-96,dx=2,dy=0,dz=2] ~~~ tellraw @a {"rawtext":[{"translate":"chat.level.easter_egg_10.failed"}]}
...
execute @e[name=counter,scores={backend=5}] ~~~ execute @e[name=remainingTime,scores={time=1..}] ~~~ tellraw @a[hasitem={item=wstd:skip,quantity=0}] {"rawtext":[{"translate":"chat.level.time_limited_4.succeed"}]}
