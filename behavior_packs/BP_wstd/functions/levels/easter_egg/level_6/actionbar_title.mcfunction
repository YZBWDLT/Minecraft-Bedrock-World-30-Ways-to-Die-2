...
# --- 非速通模式 ---
execute if score speedrunMode settings matches 0 as @a run titleraw @s actionbar {"rawtext":[{"translate":"%%s %%s | §7%%s","with":{"rawtext":[{"translate":"title.easter_egg_7"},{"translate":"subtitle.easter_egg_7"},{"translate":"actionbar.description.easter_egg_7"}]}}]}
