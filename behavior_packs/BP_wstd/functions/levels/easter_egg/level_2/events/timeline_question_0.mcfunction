...
execute as @a if entity @s[x=-68,y=21,z=-23,r=1] run tellraw @s {"rawtext":[{"translate":"chat.level.easter_egg_2.question_0.right"}]}
## 触发回答正确函数
...
execute as @a if entity @s[x=-68,y=21,z=-27,r=1] run tellraw @s {"rawtext":[{"translate":"chat.level.easter_egg_2.question_0.wrong"}]}
## 触发回答错误函数
