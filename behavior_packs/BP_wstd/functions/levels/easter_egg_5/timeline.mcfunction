...
# 检测物品
execute @e[name=timeline,scores={time=19}] ~~~ execute @e[name=itemTester1,scores={active=2}] ~~~ execute @a[hasitem={item=iron_pickaxe}] ~~~ scoreboard players set @e[name=itemTester1] active 1
execute @e[name=itemTester1,scores={active=1}] ~~~ clear @a minecraft:iron_pickaxe
...
execute @e[name=timeline,scores={time=19}] ~~~ execute @e[name=itemTester2,scores={active=2}] ~~~ execute @a[hasitem={item=diamond_pickaxe}] ~~~ scoreboard players set @e[name=itemTester2] active 1
execute @e[name=itemTester2,scores={active=1}] ~~~ clear @a minecraft:diamond_pickaxe
