...
### 英文补丁
execute @e[name=level30Dialogue,scores={settings=0}] ~~~ execute @e[name=counter,scores={backend=0}] ~~~ execute @e[name=ticker,scores={time=0}] ~~~ execute @e[name=language,scores={settings=1}] ~~~ structure load level_30_en_patch -123 66 77
#### 当未获得[禁止套娃]进度时，放置木桶
