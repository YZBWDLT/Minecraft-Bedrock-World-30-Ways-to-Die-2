...
execute unless score level data matches -18 unless score level data matches -5 unless score level data matches 0..60 run tellraw @s {"rawtext":[{"translate":"functions.general.error.not_normal_levels"}]}
execute unless score level data matches -18 unless score level data matches -5 unless score level data matches 0..60 run clear @s wstd:reset
